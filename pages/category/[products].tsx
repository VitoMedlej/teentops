...
//  console.log('skip: ', skip);
  ...
  return (
    <>
    <Head>
    <title>Teentops lb Electronics | Shop By Category </title>
...
<meta name="og:description" content={`
       ...
       <meta name="description" content={` Shop different ${router?.query?.products} from Teen Tops for the best european house appliances. We deliver anywhere in lebanon | Best online shop in lebanon.`} />
